...
Polaris Assistant (`apps/polaris-assistant`) executes an autonomous ReAct loop querying Gemini and invoking tools exposed by Polaris Core over MCP (`ExternalMcpHub`).
